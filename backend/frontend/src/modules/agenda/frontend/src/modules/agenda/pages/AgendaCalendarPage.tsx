    ...
    <ContentLayout>
      <div className="agenda-calendar-container">
        ...
        <div className="agenda-calendar-grid">
          ...
          <Card>
            <div className="agenda-calendar-card">
              <p className="agenda-calendar-date">Martes</p>
              <p className="agenda-calendar-event">Sin citas</p>
            </div>
          </Card>
          ...
          <Card>
            <div className="agenda-calendar-card">
              <p className="agenda-calendar-date">Miércoles</p>
              <p className="agenda-calendar-event">Sin citas</p>
            </div>
          </Card>
          ...
          <Card>
            <div className="agenda-calendar-card">
              <p className="agenda-calendar-date">Jueves</p>
              <p className="agenda-calendar-event">Sin citas</p>
            </div>
          </Card>
          ...
          <Card>
            <div className="agenda-calendar-card">
              <p className="agenda-calendar-date">Viernes</p>
              <p className="agenda-calendar-event">Sin citas</p>
            </div>
          </Card>
          ...
          <Card>
            <div className="agenda-calendar-card">
              <p className="agenda-calendar-date">Sábado</p>
              <p className="agenda-calendar-event">Sin citas</p>
            </div>
          </Card>
          ...
          <Card>
            <div className="agenda-calendar-card">
              <p className="agenda-calendar-date">Domingo</p>
              <p className="agenda-calendar-event">Sin citas</p>
            </div>
          </Card>
        </div>
